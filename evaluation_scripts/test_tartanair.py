...
sys.path.append('/home/honsen/honsen/VO_SLAM/DROID-SLAM/thirdparty/tartanair_tools')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--buffer", type=int, default=600)
    ...
    parser.add_argument("--keyframe_thresh", type=float, default=2)
    ...
    args = parser.parse_args(["--datapath", "/home/honsen/tartan/test/tartanair-test-mono-release/mono",
                              "--gt_path", "/home/honsen/tartan/test/tartanair-test-mono-release/groundtruth",])
